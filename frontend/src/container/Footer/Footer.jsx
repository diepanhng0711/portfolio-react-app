...
const Footer = () => {
  ...
  return (
    <React.Fragment>
      <h2 className="head-text">Buy Me A Coffee & Chat With Me</h2>

      <div className="app__footer-cards">
        <div className="app__footer-card">
          <img src={images.email} alt="email" />
          <a href="mailto:diepanhng0711@gmail.com" className="p-text">diepanhng0711@gmail.com</a>
        </div>
        <div className="app__footer-card">
          <img src={images.mobile} alt="mobile" />
          <a href="tel:+84946103302" className="p-text">+(84) 946103302</a>
        </div>
      </div>
